...
|---|---|---|
| [`01_data_audit_and_cleaning.ipynb`](notebooks/01_data_audit_and_cleaning.ipynb) | Audit, clean and separate purchases and returns | [Open](https://colab.research.google.com/github/YOUR_USERNAME/online-retail-customer-value-analytics/blob/main/notebooks/01_data_audit_and_cleaning.ipynb](https://github.com/DularaMadhusanka/online-retail-customer-value-analytics/blob/main/notebooks/01_Data_Audit_and_Cleaning.ipynb)) |
